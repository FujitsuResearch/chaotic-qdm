...
# Data params
class DParams():
    def __init__(self, dat_name, n_atoms, n_rings, input_type, n_train, n_test):
...
def execute_job(bin, nparams, dparams, oparams, qaeparams, save_dir, load_params, rseed, plot_bloch, n_threads):
    ...
    cmd = f'python {bin} \
            ...
            --n_atoms {dparams.n_atoms} \
            --n_rings {dparams.n_rings} \
...
if __name__ == '__main__':
    ...
    for dat_name in dat_names:
        for input_type in input_type_ls:
            dparams = DParams(dat_name, n_atoms=n_atoms, n_rings=n_rings, input_type=input_type, n_train=n_train, n_test=n_test)
