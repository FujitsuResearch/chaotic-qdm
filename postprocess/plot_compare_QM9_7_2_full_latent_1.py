...
if __name__ == "__main__":
    ...
    # Full directory
    parser.add_argument('--full_dir', type=str, default='../results_2026/20260112_train_qm9_mol_7_2/qm9_qubits_7_dat_488_npj_3')
    parser.add_argument('--full_base', type=str, default='qm9_atoms_7_rings_2_Ising_nearest_3_full_0.02_rxycz_qubits_7_3_steps_20_wass_lays_10_in_product_dat_200_488_epoch_2001_100_lr_0.001_init_1.0_vd_0.0')

    # Latent directory
    parser.add_argument('--lat_dir', type=str, default='../results_2026/20251224_train_qm9_mol_7_2/qm9_qubits_7_dat_488_npj_2')
    parser.add_argument('--lat_base', type=str, default='qm9_atoms_7_rings_2_Ising_nearest_2_full_0.02_qae_latent_4_lays_20_epoch_2000_lr_0.001_rxycz_qubits_7_2_steps_20_wass_lays_10_in_product_dat_200_488_epoch_2001_100_lr_0.001_init_1.0_vd_0.0')
    ...
    fig, axs = plt.subplots(1, 3, figsize=(21,7), squeeze=False, sharey=False)
    axs = axs.ravel()
    ...
    colors = [putils.RED_m, putils.BLUE_m, putils.GREEN_m, putils.BROWN]
